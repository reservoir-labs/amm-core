...
import { MockAssetManager } from "test/__mocks/MockAssetManager.sol";
...
contract UniswapV2PairTest is BaseTest
{
    ...
    function testSetManager() external
    {
        ...
        _uniswapV2Pair.setManager(_mockManager);

        // assert
        assertEq(address(_uniswapV2Pair.assetManager()), address(_mockManager));
    }
    ...
    function testSetManager_CannotMigrateWithManaged() external
    {
        ...
        _mockManager.adjustManagement(_uniswapV2Pair, 10e18, 10e18);
    ...
    function testManageReserves_KStillHolds() external
    {
        ...
        _mockManager.adjustManagement(_uniswapV2Pair, 50e18, 50e18);
    ...
    function testManageReserves_DecreaseManagement() external
    {
        ...
        _mockManager.adjustManagement(_uniswapV2Pair, 20e18, 20e18);
        ...
        assertEq(IERC20(lToken0).balanceOf(address(_mockManager)), 20e18);
        assertEq(IERC20(lToken1).balanceOf(address(_mockManager)), 20e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), address(lToken0)), 20e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), address(lToken1)), 20e18);
        ...
        assertEq(IERC20(lToken0).balanceOf(address(_mockManager)), 10e18);
        assertEq(IERC20(lToken1).balanceOf(address(_mockManager)), 10e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), address(lToken0)), 10e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), address(lToken1)), 10e18);
    }
    ...
    function testSyncManaged() external
    {
        ...
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), lToken0), 20e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), lToken1), 20e18);

        // act
        _mockManager.adjustBalance(address(_uniswapV2Pair), lToken0, 19e18); // 1e18 lost
        _mockManager.adjustBalance(address(_uniswapV2Pair), lToken1, 19e18); // 1e18 lost
        _uniswapV2Pair.transfer(address(_uniswapV2Pair), 10e18);
        _uniswapV2Pair.burn(address(this));

        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), lToken0), 19e18);
        assertEq(_mockManager.getBalance(address(_uniswapV2Pair), lToken1), 19e18);
